---
title: "Streaming"
description: "Server-Sent Events for incremental output — Chat Completions, Responses, and Anthropic Messages."
icon: "zap"
---
...
<CodeGroup>
  ...
  client = Anthropic(base_url="https://api.clearmaas.com", api_key="sk-clearmaas-...")
