...
info:
  ...
  description: |
    ...
    directly to upstream providers â€?OpenAI, Anthropic, Google Gemini,
    DeepSeek, xAI Grok, Alibaba Qwen, Moonshot Kimi, MiniMax, and Kling
    (video) â€?at provider cost price. You pay what the provider charges.
    ...
    ChatCompletionRequest:
      ...
      properties:
        model:
          type: string
          description: |
            Model ID â€?provider-prefixed (e.g. `openai/gpt-4o-mini`), bare alias, or named router (e.g. `clearmaas/auto`).
