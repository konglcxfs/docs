...
description: "OpenAI Responses API. Supported on OpenAI models and xAI Grok models — xAI's Agent Tools API uses the same shape. Anthropic and Gemini targets return `not_implemented`."
icon: "inbox"
---
