...
`https://api.clearmaas.com/v1/messages` â€?ClearMaas's first-class
...
The SDK uses the standard `x-api-key` header to send `api_key` â€?
...
* [Native Formats / Anthropic](/native-formats/anthropic) â€?the raw HTTP shape
* [Models](/getting-started/models) â€?full Claude model list
