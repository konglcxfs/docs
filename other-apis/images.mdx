...
1. **`/v1/images/generations`** â€?OpenAI image API shape. Best for
   dedicated image-generation models (DALL-E replacement family,
   Imagen, Grok Imagine).
2. **`/v1/chat/completions`** â€?chat-style image generation. Best when
...
These models are not callable via `/v1/images/generations` â€?use
chat completions for them.

## See also

* [API Reference / Images](/api-reference/images/create-an-image) â€?full schema with try-it
