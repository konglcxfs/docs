...
Use this with OpenAI's TTS model family â€?`openai/tts-1`,
...
are not served on `/v1/audio/speech` â€?call them through Gemini's
...
* [API Reference / Audio](/api-reference/audio/generate-speech) â€?full schema with try-it
* [Native Formats / Gemini](/native-formats/gemini)
* [Advanced / Audio input](/advanced/audio-input) â€?sending audio TO a chat model
